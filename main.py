...
# BackGround Music
fireSound = mixer.Sound('Assets/laser.wav')
hitSound = mixer.Sound('Assets/gunHit.ogg')
...
# Score
score = 0
font = pygame.font.Font('Assets/FiraCode-Bold.ttf', 42)
textX, textY = 570, 10

# Game Over
gameOverFont = pygame.font.Font('Assets/Poppins-Bold.ttf', 72)
